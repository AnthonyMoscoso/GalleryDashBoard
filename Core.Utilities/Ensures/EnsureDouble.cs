...
{
    public class EnsureDouble
    {
        private readonly double _argument;
        private readonly string _argumentName;
        public EnsureDouble(double argument, string argumentName = "")
        {
            _argument = argument;
        ...
        public void IsGreatherThat(double value, string message = "")
        {
            if (_argument < value)
            {
        ...
        public void IsLowerThat(double value, string message = "")
        {
            if (_argument > value)
            {
                message = string.IsNullOrWhiteSpace(message) ? _argumentName : message;
        ...
        public void IsBetweenThat(double num1, double num2, string message = "")
        {
            if (num1 > num2)
            {
