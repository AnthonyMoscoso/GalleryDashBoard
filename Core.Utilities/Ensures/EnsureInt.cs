...
{
    public class EnsureInt
    {
        private readonly int _argument;
        private readonly string _argumentName;
        public EnsureInt(int argument, string argumentName = "") 
        {
            _argument = argument;
        ...
        public void IsGreatherThat(int value,string message ="")
        {
            if (_argument<value)
            {
        ...
        public void IsLowerThat(int value, string message = "")
        {
            if (_argument > value)
            {
                message = string.IsNullOrWhiteSpace(message) ? _argumentName : message;
        ...
        public void IsBetweenThat(int num1,int num2, string message = "")
        {
            if (num1 > num2)
            {
